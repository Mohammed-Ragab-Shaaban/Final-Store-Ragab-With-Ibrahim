...
export default function BuyPage() {
  ...
  const { selectedProduct, setSelectedProduct, ren, setRen } =
  ...
  const p = selectedProduct
    .map((el, index) => {
      return +el.attributes.price * +el.count;
    })
    .reduce(function (x, xx) {
      x += xx;
      return x;
  ...
  return (
    <div style={{ backgroundColor: "var(--bgProducts)" }}>
      ...
      <div className="container py-4">
        ...
        <div className="d-flex gap-2">
            <input type="radio" id="html" name="fav_language" value="HTML" /> {" "}
          <label htmlFor="html">Payoneer</label>
          <br />
          <img src={payneer} alt="Picture" style={{ width: "50px" }} />
        </div>
        <div className="d-flex gap-2">
            <input type="radio" id="html" name="fav_language" value="HTML" /> {" "}
          <label htmlFor="html">MasterCard</label>
          <br />
        ...
        <div className="text-center">
          {" "}
          <button style={{ width: "100%" }} className="btn btn-success mt-3">
            Buy Now
          </button>
        </div>
      </div>
